...
targetImage = cv2.imread('images/elephant.png')
...
class PlaneTracker:
    ...
    def add_target(self, image, rect, data=None):
        ...
        target = PlanarTarget(image=image, rect=rect,
                              keypoints=raw_points, descrs=descs, data=data)
    ...
    def track(self, frame):
        ...
        for imgIdx, matches in enumerate(matches_by_id):
            ...
            for (x, y) in np.int32(p1):
                cv2.circle(frame, (x, y), 8, (255, 255, 0))
