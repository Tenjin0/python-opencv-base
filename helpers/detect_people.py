...
class Detect_people:
    ...
    CALIBRATION_MODE_1 = (400, (3, 3), (32, 32), 1.01, 0.999)
    ...
    CALIBRATION_MODE_7 = (400, (8, 8), (32, 32), 1.03, 0.999)
    # People large size
    CALIBRATION_MODE_8 = (400, (8, 8), (32, 32), 1.03, 0.8)
    ...
    def set_calibration(self, idx=None, tup=None):
        ...
        :return: None
        '''
        print(len(self.CALIBRATION_MODES))
    ...
    def find_people(self, img):
        ...
        #     rects, probs=None, overlapThresh=0.999)
